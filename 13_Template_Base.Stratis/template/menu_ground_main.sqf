...
if (_s3passedArguement == "delete_any") exitWith {
    private _spCheck = nearestObjects [getPos ground_check_main, ["AllVehicles"], 5];
    {deleteVehicle _x} forEach _spCheck;
};

private _season = MEU_templateSeason;
private _obj_pos = getPos ground_check_main;
private _obj_dir = getDir ground_check_main;
