...
rc1b addAction ["200m Targets Up","[[0],'meu_Func_200_targets',false,false] spawn BIS_fnc_MP;",1];
rc1b addAction ["200m Targets Down","[[1],'meu_Func_200_targets',false,false] spawn BIS_fnc_MP;",1];
rc1b addAction ["300m Targets Up","[[0],'meu_Func_300_targets',false,false] spawn BIS_fnc_MP;",1];
rc1b addAction ["300m Targets Down","[[1],'meu_Func_300_targets',false,false] spawn BIS_fnc_MP;",1];
rc1b addAction ["500m Targets Up","[[0],'meu_Func_500_targets',false,false] spawn BIS_fnc_MP;",1];
rc1b addAction ["500m Targets Down","[[1],'meu_Func_500_targets',false,false] spawn BIS_fnc_MP;",1];
rc1b addAction ["Clear Score","[[player],'meu_Func_clear_my_score',false,false] spawn BIS_fnc_MP;"];
rc1b addAction ["Clear All Scores","[[[]],'meu_Func_clear_all_scores',false,false] spawn BIS_fnc_MP;",1];

rc2b addAction ["Clear Score","[[player],'meu_Func_clear_my_score',false,false] spawn BIS_fnc_MP;"];
rc2b addAction ["Clear All Scores","[[[]],'meu_Func_clear_all_scores',false,false] spawn BIS_fnc_MP;",1];
rc2b addAction ["Start Uknown Dist Course","[[],'meu_Func_Ukn_Dst_Random',false,false] spawn BIS_fnc_MP;",1];
*/